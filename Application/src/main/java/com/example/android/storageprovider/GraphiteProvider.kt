 ...
 */
class GraphiteProvider : DocumentsProvider() {
    ...
    override fun onCreate(): Boolean {
        ...
        runOnV8Thread {
            mSession = BlockstackSession(context, config, executor = object : Executor {
    ...
    companion object {
        private val TAG = "GraphiteProvider"
        ...
        val config = "https://app.graphitedocs.com".toBlockstackConfig(arrayOf(Scope.StoreWrite))
    }
